  ...
  <view class="discover-page">
    ...
    <view class="food-recognize card">
      <view class="fridge-box">
        <view class="fridge-door">
          <view class="shelf shelf-one"><text>🥚</text><text>🍄</text><text>🥬</text></view>
          <view class="shelf shelf-two"><text>🍅</text><text>🍋</text><text>🥕</text><text>🥒</text></view>
          <view class="shelf shelf-three"><text>🥦</text><text>🫑</text><text>🥗</text></view>
        </view>
      ...
      <view class="recognize-main">
        ...
        <view class="ingredient-grid">
          <view v-for="item in ingredients" :key="item.name" class="ingredient-card">
    ...
    <view class="ai-card card">
      ...
      <view class="ai-list">
        <view v-for="item in aiTags" :key="item.title" class="ai-item">
          <text class="ai-icon">{{ item.icon }}</text>
          <view><text class="ai-title">{{ item.title }}</text><text class="ai-desc">{{ item.desc }}</text></view>
        </view>
      </view>
    </view>
    ...
    <view class="tabbar">
      <view class="tab-item"><text>⌂</text><text>首页</text></view>
      <view class="tab-item"><text>☰</text><text>菜谱</text></view>
      <view class="tab-item publish"><text>＋</text><text>发布</text></view>
      <view class="tab-item active"><text>◒</text><text>发现</text></view>
      <view class="tab-item"><text>♙</text><text>我的</text></view>
    </view>
  </view>
</template>
